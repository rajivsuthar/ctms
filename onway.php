...
<div class="col-md-12 mt-lg-4 mt-4">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">On the way for collecting sample of following tests :</h1>
          </div>
		  </div>
<div class="col-md-12">
       <div class="row">
...
join patients on patients.MobileNumber=testrecord.PatientMobileNumber where ReportStatus='On the Way for Collection'");
$cnt=1;
