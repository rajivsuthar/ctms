...
//getting post values
    ...
    $query="insert into phlebotomist(EmpID,FullName,MobileNumber) values('$empid','$fname','$mnumber')";
    $result =mysqli_query($con, $query);
    if ($result) {
     echo '<script>alert("Phlebotomist created successfully.")</script>';
    echo "<script>window.location.href='addp.php'</script>";
    }  
  else {
...
<div class="col-md-12 mt-lg-4 mt-4">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Phlebotomist :</h1>
          </div>
		  </div>
<div class="col-md-12">
       <div class="row">
        ...
        <!-- /.container-fluid -->
        <form name="addphlebotomist" method="post" style="margin-left:30px;">
  <div class="row">
