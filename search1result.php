...
<div class="col-md-12 mt-lg-4 mt-4">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">B/w Dates Report Search Result :</h1>
          </div>
		  </div>
<div class="col-md-12">
       <div class="row">
...
?>     
       ...
       <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold" style="color:#222e3c;">B/W Dates Report Results</h6>
                        </div>
                        <div class="card-body">
...
where date(testrecord.RegistrationDate) between '$fdate' and '$tdate'
    ");
$cnt=1;
...
?>
                                ...
                                <a href="testdetails.php?tid=<?php echo $row['testid'];?>&&oid=<?php echo $row['OrderNumber'];?>" class="btn btn-info btn-sm" target="blank">View Details</a> 
