...
<div class="col-md-12 mt-lg-4 mt-4">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">B/w Dates Report Date Selection :</h1>
          </div>
		  </div>
<div class="col-md-12">
       <div class="row">
        ...
        <form method="post" action="search1result.php" style="margin-left:30px;">
  <div class="row">
...
<div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" style="background:#2c3e52;" name="submit" value="Submit">                           
                             </div>
